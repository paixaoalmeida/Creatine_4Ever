...
def BuyCreatine():
    ...
    email = driver.find_element('xpath', '/html/body/main/section/div/div[1]/div/div[2]/div/form/div[1]/div[1]/input').send_keys('Ur_passwd')
    ...
    passwd = driver.find_element('name', 'senha').send_keys("Ur_passwd")
